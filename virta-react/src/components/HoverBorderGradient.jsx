...
export function HoverBorderGradient({
  ...
  const rotateDirection = useCallback((currentDirection) => {
    const directions = [Direction.TOP, Direction.LEFT, Direction.BOTTOM, Direction.RIGHT];
  ...
  const movingMap = {
    ...
    [Direction.BOTTOM]: "radial-gradient(20.7% 50% at 50% 100%, hsl(0, 0%, 100%) 0%, rgba(255, 255, 255, 0) 100%)",
    [Direction.RIGHT]: "radial-gradient(16.2% 41.199999999999996% at 100% 50%, hsl(0, 0%, 100%) 0%, rgba(255, 255, 255, 0) 100%)",
  };
